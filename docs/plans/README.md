...
This index tracks implementation status for each plan document as of `2026-05-15`.
...
| `2026-05-12-phase-4-platform-integration.md` | Open | Dedicated `boot-entry` command family and integration tasks not started yet. |
